...
<div style="text-align: center;">
    <img src="https://i.ibb.co/G3PbbJL5/Screenshot-2026-02-21-174103.png" style="width: 70%;"/>
    <p><em>Screenshot of Webapp MVC(UI)</em></p>
</div>
...
<div style="text-align: center;">
    <img src="https://i.ibb.co/21Mhv3dQ/Screenshot-2026-02-21-174110.png" style="width: 70%;"/>
    <p><em>Screenshot of RESTFull API(SWAGGER UI)</em></p>
</div>
...
<div style="text-align: center;">
    <img src="https://i.ibb.co/KjVBTGG3/Screenshot-2026-02-21-174126.png" style="width: 70%;"/>
    <p><em>Screenshot of Webapp MVC(UI) and RESTFull API(SWAGGER UI)</em></p>
</div>
